...
## for this long Rmd script, trying to suppress messages - note instead add results = FALSE in setup line
## doesn't work: r setup, include = FALSE, echo = FALSE, results = FALSE, message = FALSE, warning = FALSE
#options(warn=-1)
